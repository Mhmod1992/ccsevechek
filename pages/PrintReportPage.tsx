                                ...
                                {findingLayout === 'cards' ? (
                                    <div className="flex flex-wrap justify-center gap-4">
                                        {findingsForCategory.map(finding => {
                                            ...
                                            return (
                                                <div key={finding.findingId} className="border rounded-lg text-center p-2 flex flex-col items-center" style={{ borderColor: styles.borderColor, breakInside: 'avoid', width: '220px' }}>
                                                    <div className="w-full h-28 flex items-center justify-center mb-2 bg-gray-100 rounded" style={{border: `1px solid ${styles.borderColor}`}}>
                                                    ...
                                                    <p className="font-semibold mt-1 text-sm">{predefinedFinding?.nameEn}</p>
                                                    <p className="font-semibold text-sm">{finding.findingName}</p>
                                                </div>
                                            )
                                        })}
                                    </div>
